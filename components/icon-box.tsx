                ...
                <p className="lowercase text-gray-400 text-sm">{title}</p>
                 ...
                 <Tooltip>
                    <TooltipTrigger asChild>
                        <div className="absolute  top-3 right-3 rounded-sm bg-gray-100 hover:bg-gray-200 p-1 cursor-pointer opacity-0 group-hover:opacity-100" onClick={() => copy(`pnpm dlx shadcn@latest add "https://grainlyicons.abhii.space/r/${title}.json"`)}>
                          {
